		...
		$.ajax({
			...
			success: function(result){
				$.each(result, function(i, danhmuc){
					...
					var content2 ='<li><a href="/laptopshop/store?brand='+danhmuc.tenDanhMuc+'"><span style=" font-size: 16px; font-weight: 900; ">'+danhmuc.tenDanhMuc+'</span></a></li>'//'<li><a  style="padding-right: 100px" href="<%=request.getContextPath()%>/store?brand='+danhmuc.tenDanhMuc+'">'+danhmuc.tenDanhMuc+'</a></li>'
