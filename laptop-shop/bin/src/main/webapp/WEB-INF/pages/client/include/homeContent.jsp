		   ...
		   <!--start-image-slider---->
					...
					<div class="image-slider">
					    ...
					    <ul class="rslides" id="slider1">
					      <li><img src="Frontend/img/lapban1.jpg" alt=""></li>
					      <li><img src="Frontend/img/lapban3.jpg" alt=""></li>
					      <li><img src="Frontend/img/lapban2.jpg" alt=""></li>
						  <li><img src="Frontend/img/lapban4.jpg" alt=""></li>
					    </ul>
						 <!-- Slideshow 2 -->
					</div>
					<!--End-image-slider---->
